...
def parse_model(d, ch, verbose=True):
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        elif m in {MobileNetV4ConvLarge, MobileNetV4ConvSmall, MobileNetV4ConvMedium, MobileNetV4HybridMedium,
                       MobileNetV4HybridLarge, MobileNetV2_n, MobileNetV2_s, MobileNetV2_m,
                       }:
            m = m(*args)
            c2 = m.width_list
            backbone = True
