...
def step1_train():
    ...
    model.train(data=yaml_path, imgsz=640, epochs=50, batch=4, workers=4,
...
def step2_constraint_train():
    ...
    model.train(data=yaml_path, imgsz=640, epochs=50, batch=4, amp=False, workers=4,
...
def step4_finetune():
    ...
    model.train(data=yaml_path, imgsz=640, epochs=200, batch=4, workers=4,
                project="runs/pruning",
...
def step5_distillation():
    ...
    model_s.train(data=yaml_path, Distillation=model_t.model, loss_type='cwd', layers=layers, amp=False, imgsz=640,
                  epochs=300,
                  batch=4, workers=4, lr0=0.001,
