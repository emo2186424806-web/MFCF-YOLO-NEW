...
def do_pruning(modelpath, savepath):
    ...
    yolo.val(data="CityPersons.yaml", batch=8, device=0, workers=4)
    torch.save(yolo.ckpt, savepath)


if __name__ == "__main__":
    modelpath = r"runs/pruning/train/Constrained Training YOLO11n/weights/best.pt"
    savepath = r"runs/pruning/train/Constrained Training YOLO11n/weights/last_prune.pt"
